...
- Primary audit tools (`audit_services`, `audit_slos`, `audit_service_operations`)
- 100% Trace Visibility via `search_transaction_spans`
- Canary Failure Analysis via `analyze_canary_failures`
